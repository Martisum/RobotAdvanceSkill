...
#include "vector.h"
const int MAX_ROBOTS = 12;  //最大玩家数
const int MAX_TEAM_ROBOTS = 6;  //最大队员数
const int MAX_ROBOT_SIZE = 9;  //机器人的半径（尾部长度）
const double BALL_SIZE = 5;  //球的直径？
const int SEGMENT_NUM = 4;
//==== Field Dimensions (cm) =========================================//
// diagonal is of 2800 x 2300 is 3623.53
const double FIELD_LENGTH = 605;  //足球场的长
const double FIELD_WIDTH = 405;  //足球场宽度
const double FIELD_LENGTH_H = (FIELD_LENGTH / 2);  //足球场中线（x轴的方向）
const double FIELD_WIDTH_H = (FIELD_WIDTH / 2);  //足球场（y轴的方向）
const double GOAL_WIDTH = 70;  //球门的宽度
const double GOAL_DEPTH = 18;  //球门内延深度
const double DEFENSE_WIDTH = 205;  //防守区宽度
const double DEFENSE_DEPTH = 85;
const double WALL_WIDTH = 1;
const double PENALTY_BUFF = 4;
const double PENALTY_AREA_R = 80;
const double PENALTY_AREA_L = 35;  //禁区前面平平的位置的宽度
...
const double ROBOT_HEAD = 7.5;  //中心点到那个平平的位置
namespace RuleParam {
