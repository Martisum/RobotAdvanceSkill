...
#include <vector>
enum RoleStyle {
	KickerS, ReceiveS, MiddleS, TierS, AssisterS, GoalieS, Nothing
};
...
#define DEG2RAD					0.017453292519943
	...
	point2f circle_segment_intersection(const point2f& start_point, double circle_r, const point2f& end_point);
